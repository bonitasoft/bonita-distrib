...
describe('Step auto generated form', function () {
  ...
  var $rootScope, scope, $location, contractSrvc, urlParser, $window, humanTaskAPI, gettextCatalog, i18nService, $q, mainCtrl, deferedTaskExecution;
  ...
  beforeEach(inject(function ($injector, $controller) {
    ...
    var deferredGetTask = $q.defer();
    spyOn(humanTaskAPI, 'get').and.returnValue(deferredGetTask);
    deferredGetTask.resolve('{"id":1}');
