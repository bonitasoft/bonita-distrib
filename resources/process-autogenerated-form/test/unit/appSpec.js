...
describe('Process auto generated form', function () {
  ...
  var $rootScope, scope, $location, contractSrvc, urlParser, $window, processAPI, gettextCatalog, i18nService, $q, mainCtrl, deferedProcessStart;
  ...
  beforeEach(inject(function ($injector, $controller) {
    ...
    spyOn(processAPI, 'get').and.returnValue(deferredGetProcess);
    deferredGetProcess.resolve('{"id":1}');
