...
describe('Process auto generated form', function () {
  ...
  var $rootScope, scope, $location, $window, $q, deferedProcessStart, $httpBackend, createController;
  ...
  beforeEach(inject(function ($injector, $controller) {
    ...
    var contractSrvcMock = jasmine.createSpyObj('contractSrvc', ['fetchContract', 'startProcess']);
