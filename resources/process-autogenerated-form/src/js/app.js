(function () {
    ...
    app.controller('MainCtrl', ['$scope', '$location', 'contractSrvc', 'urlParser', '$window', 'processAPI', 'i18nService', '$http', '$filter', function ($scope, $location, contractSrvc, urlParser, $window, processAPI, i18nService, $http, $filter) {
