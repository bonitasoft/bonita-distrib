...
BONITA_DS_CONNECTION_POOL_MAX_TOTAL=${BONITA_DS_CONNECTION_POOL_MAX_TOTAL:-}
BONITA_DS_CONNECTION_POOL_MIN_IDLE=${BONITA_DS_CONNECTION_POOL_MIN_IDLE:-}
BONITA_DS_CONNECTION_POOL_MAX_IDLE=${BONITA_DS_CONNECTION_POOL_MAX_IDLE:-}
BDM_DS_CONNECTION_POOL_INITIAL_SIZE=${BDM_DS_CONNECTION_POOL_INITIAL_SIZE:-}
BDM_DS_CONNECTION_POOL_MAX_TOTAL=${BDM_DS_CONNECTION_POOL_MAX_TOTAL:-}
BDM_DS_CONNECTION_POOL_MIN_IDLE=${BDM_DS_CONNECTION_POOL_MIN_IDLE:-}
BDM_DS_CONNECTION_POOL_MAX_IDLE=${BDM_DS_CONNECTION_POOL_MAX_IDLE:-}
