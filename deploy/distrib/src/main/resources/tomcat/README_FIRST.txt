# Welcome to Bonita BPM Community edition Tomcat bundle
...
* Run start-bonita.sh (Unix) or start-bonita.bat (Windows) to launch the Bonita BPM Community Tomcat bundle
...
* Restart the Bonita BPM Community Tomcat bundle so the new configuration is taken into account
